---
name: alanhou-social-card
description: Generate house-style social card image sets, Live Photo motion cards, material-first Live Photo puzzle layouts, triple Live Photo collages, long-video-to-Live-Photo treatments, and WeChat official account cover pairs from articles, scripts, screenshots, product notes, subtitles, photos, or user-supplied videos. Use when the user asks for 小红书图文, Rednote/Xiaohongshu images, social cards, carousel images, 3:4 covers, Live Photo, 实况照片, 单视频实况拼图, 二宫格实况拼图, 三连实况拼图, 四宫格实况拼图, 微信公众号封面, WeChat 21:9 + 1:1 covers, Swiss Style, or magazine-style social images.
---

# Alanhou Social Card Skill

<!-- attribution: alanhou-social-card is derived from guizang-social-card-skill by 歸藏 (https://github.com/op7418/guizang-social-card-skill), AGPL-3.0, see LICENSE. Keep this notice in the skill; never write it into generated images or HTML. -->
...
This skill is self-contained. It borrows visual principles from the alanhou-ppt style system, but it must not edit the original PPT skill, its templates, or its references. If the original PPT skill is available, you may read it for reference only.
...
- Social images that need house-style Swiss or editorial magazine layouts.
...
- `references/style-system.md` for house editorial and Swiss visual rules.
...
- Never edit the original alanhou-ppt skill or any upstream skill copied from elsewhere.
