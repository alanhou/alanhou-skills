...
当图片槽位需要的是**实拍照片**(人文纪实 / 风景 / 城市 / 物件 / 氛围 hero、S15/S16 图片网格、左文右图的 quote 配图)而用户没有素材时,可以从 Pexels / Unsplash / Pixabay 图库取图。信息图、流程图、截图再设计、概念图**不走图库**——那些要么用模板画,要么走 GPT-M 2.0。
